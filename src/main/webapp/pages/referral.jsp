	...
	<div class="row">
		...
		<div class="card border-success">
                    <div class="card-header">
                        <h4 class="card-title text-center">Add Refer Note</h4>
                    </div>
                    <div class="card-body">
                    	<form action="/admin/all/referral/add/${user.username}" method="POST">
				            ...
				            <div class="form-group">
				                <label for="address">Recipient Address: (Seperate with comma (,))</label>
