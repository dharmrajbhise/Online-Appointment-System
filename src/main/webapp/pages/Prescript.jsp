...
<div class="container">
	<div class="row">
		...
		<div class="card border-success">
                    ...
                    <div class="card-body">
                    	<form action="/admin/all/prescriptions/add/${user.username}" method="POST">
				            ...
				            <div class="form-group">
				                ...
				                <input type="text" class="form-control" id="username" value="${full }"  name="doctor" required>
				            </div>
				            ...
				            <div class="form-group">
				                <label for="input">Medicines: (Seperate with comma (,))</label>
				                <textarea id="input" name="medicines" class="form-control" rows="5" required></textarea>
				            </div>
				            ...
				            <div class="form-group">
				                <label for="instructions">Instructions: (Seperate with comma (,))</label>
        ...
        <table class="table table-responsive mt-4">
            ...
            <c:forEach var="e" items="${prescript}">
                <tr class="table-row">
                    ...
                    <td>
                    <a href="/admin/all/prescriptions/download/${e.id}" class="btn btn-success">Download</a>
                    </td>
                </tr>
               </c:forEach>
