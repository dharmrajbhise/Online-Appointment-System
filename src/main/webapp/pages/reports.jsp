        ...
        <div class="row">
            <div class="col-md-8 offset-md-2">
                ...
                <div class="card border-success">
                    ...
                    <div class="card-body">
                    <form id="dateFilterForm" method="Post" action="/admin/all/labReports/add${username }" enctype="multipart/form-data">
                    	<div class="form-group">
				                <label for="username">Username:</label>
				                <input type="text" class="form-control" id="username" value="${username }"  name="username" required>
				            </div>
            			...
            			<div class="form-group">
						  ...
						  <input class="form-control" type="file" id="formFile" name="file" accept=".pdf,.doc,.docx,.txt" required>
						</div>
